...
% At first blush, there would seem to be three ways to resist this argument:
% 	\begin{itemize}
% 		\item Deny that colors are looks
% 		\item Accept that colors are looks but deny that there are any further looks of these \citep[see][]{Siewert:2006rt}
% 		\item Accept that colors are looks but deny that there is any incoherence involved in their having further looks \citep[see][]{Allen:2008kx}
% 	\end{itemize}
% This assumes, of course, that the sense of ``looks'', as it occurs in Noë's argument, is univocal. 

Colors \emph{are} looks, on at least one reasonable construal of that claim. As \citet[109]{Strawson:1966kx} remarks, ``colours are visibilia or they are nothing''. But visibilia can themselves have looks or appearances. Among the visibilia I encounter upon entering the wedding party is Edgar's dour look. a look that looked out of place on that happy occasion. However, pointing out hat looks can sometimes iterate does not entail that they always do. There may yet be a problem specific to color appearances.
...
Similarly, for color appearances. The gray appearance of the wall made Edgar melancholy. This statement admits of different construals on different occasions. Edgar may be melancholy because of the dark look of the wall. Or Edgar may be melancholy because the color scheme for the room he is decorating has unexpectedly gone awry. In each case, we may say that Edgar was made melancholy by the gray appearance of the wall, but there is no one thing that is the gray appearance on each occasion.

In the first case, the gray appearance is some visible aspect of the wall---a visible aspect that grounds objective similarities to other visible things. In looking gray, the wall may, for example look the way an unshadowed gray thing would look like. It is this visible aspect that makes Edgar melancholy. Looking this way needn't mean that the wall is gray, or even looks to be gray. Think of the by now familiar white wall cast in shadow. If we remain within the limits of human color constancy, then the shadowed white thing looks like an unshadowed gray thing even though it does not look to be gray. It may be white, and seen to be white by Edgar, but its dark look under present conditions of illumination is sufficient to provoke gloom. In the second case, it is the presence of grayness and not the gray look of a non-gray thing that depresses Edgar---it simply doesn't fit his present decorating scheme. The gray appearance of the wall is the grayness of the wall made evident in Edgar's experience of it. Edgar sees the gray of the wall. It looks to be gray.


The wall appears gray. How are we to understand this? The wall may look the way a gray wall would look like under some contextually salient circumstances.  On another construal to say that the wall appears gray is to say that the grayness of the wall is made evident in our experience of it. We see the gray of the wall. It looks to be gray.
